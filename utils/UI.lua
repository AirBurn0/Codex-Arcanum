...
local category_tabs = {
    ...
    seals = {
        init = function()
            ...
            return create_category_pane{ text = loc[1], nodes = {
                config_category_button(loc[2], "seals", G.C.RED)
            } }
        end
    },
    stickers = {
        init = function()
            ...
            return create_category_pane{ text = loc[1], nodes = {
                config_category_button(loc[2], "stickers", G.C.RED)
            } }
        end
    }
}
        ...
        nodes = {
            {
                ...
                nodes = {
                    ...
                    config_category_button("seals", G.C.SECONDARY_SET.Planet),
                    config_category_button("stickers", HEX('ffc75985')),
                }
            }
        }
    }
