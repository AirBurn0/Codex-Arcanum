...
function G.UIDEF.use_and_sell_buttons(card, dobdob, yesyes)
    if (card.ability.set == "Alchemical" or card.ability.name == "c_alchemy_philosopher_stone") and G.STATE == G.STATES.SMODS_BOOSTER_OPENED and (card.area == G.pack_cards and G.pack_cards) then
