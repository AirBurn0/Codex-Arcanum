...
new_tag{
    ...
    apply = function()
        local key = CodexArcanum.config.modules.BoosterPacks["p_alchemy_mega_1"] and "p_alchemy_mega_1" or CodexArcanum.utils.get_first_key_enabled(CodexArcanum.config.modules.BoosterPacks, "p_arcana_mega_1")
